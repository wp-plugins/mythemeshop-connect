...
class mts_connection {
    ...
    function __construct() {
        ...
        // Fix false wordpress.org update notifications ( seems like it is not needed for plugins )
        add_filter( 'pre_set_site_transient_update_themes', array(&$this,'disable_wp_org_theme_check') );
    ...
    function admin_init() {
        ...
        wp_localize_script('mts-connect', 'mtsconnect', array(
            ...
            'l10n_insert_username' => __('Please insert your MyThemeShop <strong>username</strong> instead of the email address you registered with.', 'mts-connect'),
        ) );
    ...
    public function disable_wp_org_theme_check( $val ){
